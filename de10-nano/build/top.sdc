...
# Specific to FIR
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[20]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[21]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[22]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[23]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[24]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[25]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[26]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[27]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[28]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[29]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[30]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[31]}]
set_output_delay -max  1.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[32]}]

set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[20]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[21]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[22]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[23]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[24]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[25]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[26]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[27]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[28]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[29]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[30]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[31]}]
set_output_delay -min  0.0 -clock virtual_ext_clk_25MHz [get_ports {GPIO_0[32]}]
